...
function mudaDados(idEmpresa){
    		...
    		// $('#dataTributacao').html(dataTributacao);
    		...
    		// $('#nContmatic').html(nContmatic);
    		// $('#cnpj').html(cnpj);
    		// $('.razaoSocial').html(razaoSocial);
    		// $('#nomeFantasia').html(nomeFantasia);
    		$('#matrizFilial').html(matrizFilial);
    		// $('#inscricaoMunicipal').html(datainscricaoMunicipal);
    		// $('#inscricaoEstadual').html(datainscricaoEstadual);
    		// $('#telefone').html(datatelefone);
    		// $('#telefoneResidencial').html(datatelefoneResidencial);
    		// $('#celular').html(datacelular);
    		// $('#email').html(dataemail);
    		// $('#cep').html(datacep);
    		// $('#logradouro').html(datalogradouro);
    		// $('#logradouroComercial').html(datalogradouroComercial);
    		// $('#numero').html(datanumero);
    		// $('#complemento').html(datacomplemento);
      //       // insereValor("#complemento", dado.complemento);
      //       $('#bairro').html(databairro);
      //       $('#municipio').html(datamunicipio);
      //       $('#uf').html(datauf);
      //       $('#atividade').html(dataatividade);
      //       $('#inicioAtividade').html(datainicioAtividade);
      //       $('#dataAbertura').html(datadataAbertura);
      //       $('#cnae').html(datacnae);
      //       $('#codCetesb').html(datacodCetesb);
      //       $('#codVigilancia').html(datacodVigilancia);
      //       $('#codConselhoRegional').html(datacodConselhoRegional);
      //       $('#codJucesp').html(datacodJucesp);
      //       $('#codAlvaraBombeiro').html(datacodAlvaraBombeiro);
