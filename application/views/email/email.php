	<div class="container">
		<div class="row">
			<header class="he_email col-lg-8">
				<img class="img-responsive"src="<?php echo base_url("img/logo.png") ?>"/>
				<h1>Ras Reviri Escritório Contábil</h1>
			</header>
		</div>
		<div class="row">
		...
		<div class="row">
			<section class="col-lg-8 jumbotron">
				<h3>Detalhes de alguma coisa</h3>
			</section>
		</div>
		<div class="row">
			<section class="linha col-lg-8">
			</section>
		</div>
		<div class="row">
			<section class="col-lg-8">
				<br/>
				<h4>Detalhes deste Teste</h4>
				<ul>
					<li>Item 1</li>
					<li>Item 2</li>
					<li>Item 3</li>
			...
			<button class="btn btn-primary btn-lg">ALGUMA FUNÇÃO</button>
		</div><br/>
		<div class="row">
			<section class="linha col-lg-8">
			</section>
